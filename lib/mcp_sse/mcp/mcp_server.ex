defmodule MCPServer do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      def handle_list_resources(_session_id, _request_id, _params), do: {:error, "Not implemented"}
  ...
  # Required Callbacks
  @callback handle_ping(session_id :: String.t(), request_id :: String.t() | integer()) ::
              {:ok, map()} | {:error, String.t()}
  @callback handle_initialize(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  # Optional Callbacks
  @callback handle_complete(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  @callback handle_list_prompts(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  @callback handle_get_prompt(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  @callback handle_list_resources(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  @callback handle_read_resource(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  @callback handle_list_tools(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}

  @callback handle_call_tool(session_id :: String.t(), request_id :: String.t() | integer(), params :: map()) ::
              {:ok, map()} | {:error, String.t()}
